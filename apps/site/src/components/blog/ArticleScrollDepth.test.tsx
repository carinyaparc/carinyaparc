...
describe('ArticleScrollDepth', () => {
  ...
  let ArticleScrollDepth: typeof import('@/components/blog/ArticleScrollDepth').ArticleScrollDepth;
  let getArticleScrollPercent: typeof import('@/components/blog/ArticleScrollDepth').getArticleScrollPercent;

  beforeEach(async () => {
    vi.resetModules();
    trackArticleScrollDepth.mockReset();

    const mod = await import('@/components/blog/ArticleScrollDepth');
